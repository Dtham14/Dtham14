...
Full-stack developer specializing in Python, React, and Flask — 
building scalable, real-time applications with ML and data-driven features.

## 🛠 Tech Stack
**Frontend:** JavaScript, React, HTML, CSS
**Backend:** Python, Flask, Node.js, REST APIs
**Data & AI:** scikit-learn, Pandas, NumPy, OpenAI API
